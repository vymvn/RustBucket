use rcgen::{CertificateParams, CertifiedKey, DnType, KeyPair, RcgenError};
...
impl CertManager {
    ...
    pub fn generate_certificates(&mut self) -> Result<(), RcgenError> {
        ...
        ca_params
            .distinguished_name
            .push(DnType::OrganizationName, "RustBucket C2");
        ca_params
            .distinguished_name
            .push(DnType::CommonName, "RustBucket CA");
        ...
        server_params
            .distinguished_name
            .push(DnType::CommonName, "RustBucket Server");
        ...
        client_params
            .distinguished_name
            .push(DnType::CommonName, "RustBucket Client");
